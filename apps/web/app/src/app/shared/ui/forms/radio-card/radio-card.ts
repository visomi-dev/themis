...
export class RadioCard implements ControlValueAccessor {
  ...
  readonly classes = computed(() =>
    uiClass(
      ...
      this.checked() ? 'border-blue-600 dark:border-blue-500 ring-2 ring-blue-500/20' : 'border-zinc-500/30 dark:border-zinc-400/30 hover:bg-zinc-100 dark:bg-zinc-800',
  ...
  readonly markerClasses = computed(() =>
    uiClass(
      ...
      this.checked() ? 'border-blue-600 dark:border-blue-500 text-accent' : 'border-zinc-500/30 dark:border-zinc-400/30 text-transparent',
    ),
  );
