...
`docs/architecture/project-foundation-model.md` recommends `project_context`, but current schema only includes `projects` and `project_documents` for project knowledge.
...
- `docs/architecture/adr-first-run-activation-frontend.md`
...
- `docs/product/onboarding-activation-prd.md`
- `docs/architecture/adr-first-run-activation-backend.md`
